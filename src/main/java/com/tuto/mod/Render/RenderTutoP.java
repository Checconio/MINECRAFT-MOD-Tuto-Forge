...
public class RenderTutoP extends RenderLiving
{
    
    private ResourceLocation texture = new ResourceLocation(Reference.MOD_ID + ":textures/mobs/TutoP.png");

    public RenderTutoP(RenderManager render, ModelBase model, float x)
    {
